  ...
  return (
    <section aria-labelledby="privacy-title" className="space-y-4 pt-2">
      ...
      <ul className="list-disc space-y-3 pl-5">
        ...
        <li>Your agreement is parsed and analysed in your browser and sent only to Google&apos;s Gemini API when you provide a key and run an AI analysis.</li>
        <li>Your Gemini key is held in memory for this tab only. It is never stored, copied to the clipboard, put in URLs, or exported.</li>
