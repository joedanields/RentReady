...
export const SAMPLE_ANALYSIS_RESPONSE = {
  ...
  matchFindings: [
    ...
    },
    {
      ...
      clauseId: 'c005',
      quote: 'a security deposit of Rs. 1,20,000/- (Rupees One Lakh Twenty Thousand only) equivalent to three months\' rent',
      ambiguity: null
    },
    {
      key: 'duration',
    ...
    },
    {
      ...
      clauseId: 'c006',
      quote: 'The Licensee shall pay all society maintenance charges, water charges, electricity charges',
      ambiguity: null
    },
    {
      key: 'repairs',
      ...
      clauseId: 'c007',
      quote: 'responsible for all repairs and maintenance of the premises including but not limited to electrical, plumbing, structural',
      ambiguity: null
    },
    {
      key: 'increase',
    ...
    },
    {
      ...
      clauseId: 'c009',
      quote: 'no visitors to remain in the premises after 10:00 p.m. and shall not permit any guests to stay overnight',
      ambiguity: null
    }
  ],
  protectionFindings: [
    { id: 'DEPOSIT_AMOUNT', state: 'present', summary: 'Deposit stated in rupees', clauseId: 'c005', quote: 'a security deposit of Rs. 1,20,000/-' },
    { id: 'DEPOSIT_REFUND_TIMELINE', state: 'absent', summary: 'No refund deadline', clauseId: null, quote: null },
    { id: 'DEPOSIT_DEDUCTION_BASIS', state: 'unclear', summary: 'Deductions as determined by Licensor', clauseId: 'c005', quote: 'subject to deductions as determined by the Licensor' },
    { id: 'RENT_AMOUNT', state: 'present', summary: 'Rent stated', clauseId: 'c004', quote: 'The Licensee shall pay monthly rent of Rs. 40,000/-' },
    { id: 'RENT_DUE_DATE', state: 'present', summary: 'Due by 7th of month', clauseId: 'c004', quote: 'payable in advance on or before the seventh day' },
    { id: 'RENT_INCREASE', state: 'absent', summary: 'No increase clause', clauseId: null, quote: null },
    { id: 'MAINTENANCE_CHARGES', state: 'present', summary: 'Tenant pays all charges', clauseId: 'c006', quote: 'The Licensee shall pay all society maintenance charges' },
    { id: 'REPAIRS_MAJOR', state: 'present', summary: 'Tenant responsible for structural repairs', clauseId: 'c007', quote: 'including but not limited to electrical, plumbing, structural and major repairs' },
    { id: 'REPAIRS_MINOR', state: 'present', summary: 'All repairs on tenant', clauseId: 'c007', quote: 'responsible for all repairs and maintenance' },
    { id: 'NOTICE_TENANT', state: 'present', summary: 'Two months notice', clauseId: 'c010', quote: 'give two months\' written notice' },
    { id: 'NOTICE_LANDLORD', state: 'present', summary: 'Two months notice', clauseId: 'c010', quote: 'give two months\' written notice' },
    { id: 'LOCK_IN', state: 'present', summary: 'Six months lock-in', clauseId: 'c003', quote: 'before the expiry of six (6) months' },
    { id: 'ENTRY_NOTICE', state: 'absent', summary: 'No entry notice clause', clauseId: null, quote: null },
    { id: 'ESSENTIAL_SERVICES', state: 'absent', summary: 'Not mentioned', clauseId: null, quote: null },
    { id: 'SUBLET_GUESTS', state: 'present', summary: 'No subletting, no visitors after 10pm', clauseId: 'c009', quote: 'no visitors to remain in the premises after 10:00 p.m.' },
    { id: 'RENEWAL', state: 'absent', summary: 'No renewal clause', clauseId: null, quote: null },
    { id: 'SALE_OF_PROPERTY', state: 'absent', summary: 'Not mentioned', clauseId: null, quote: null },
    { id: 'REGISTRATION_STAMPING', state: 'unclear', summary: 'Not addressed', clauseId: null, quote: null },
    { id: 'INVENTORY_HANDOVER', state: 'absent', summary: 'No inventory schedule', clauseId: null, quote: null },
    { id: 'DISPUTE_RESOLUTION', state: 'present', summary: 'Arbitration in Sample City', clauseId: 'c013', quote: 'shall be referred to arbitration at Sample City' }
  ]
};
...
export const SAMPLE_ASK_RESPONSES: Array<{ question: string; response: unknown }> = [
  {
    ...
    response: {
      ...
      citations: [
        { clauseId: 'c003', quote: 'shall not vacate the premises before the expiry of six (6) months' },
  ...
  },
  {
    ...
    response: {
      ...
      citations: [
        { clauseId: 'c011', quote: 'The Licensor shall be entitled to re-enter the premises and take possession' }
      ],
  ...
  items: [
    {
      ...
      suggestedWording: 'Security deposit: Rs. 80,000 (two months\' rent), refundable within 15 days of handing over vacant possession.'
    },
    {
      rowId: 'match-lockIn',
    ...
    },
    {
      ...
      suggestedWording: 'The deposit shall be refunded within 15 days of handing over vacant possession.'
    },
    {
      ...
      suggestedWording: 'The Owner shall give at least 24 hours\' written notice before entry, except in an emergency.'
    },
    {
    ...
    },
    {
      ...
      suggestedWording: 'The Tenant may receive visitors; overnight stays beyond a week require consent.'
    }
  ]
};